...
export const ContactForm: React.FC<ContactFormProps> = ({ bookingText = "Booking DJ", customSubject }) => {
        ...
        <FormContainer onSubmit={handleSubmit}>
            <InputContainer>
                <InputWrapper>
                    ...
                    <InputField type="text" name="firstName" placeholder="Nom *" value={inputForm.firstName} onChange={handleChange} />
                    {errors.firstName && <ErrorMessage>{errors.firstName}</ErrorMessage>}
                </InputWrapper>
                <InputWrapper>
                    <HiddenLabel id="lastName">Prénom</HiddenLabel>
                    <InputField type="text" name="lastName" placeholder="Prénom *" value={inputForm.lastName} onChange={handleChange} />
            ...
            <InputContainer>
                <InputWrapper>
                    ...
                    <InputField type="email" name="email" placeholder="Email *" value={inputForm.email} onChange={handleChange} />
                    {errors.email && <ErrorMessage>{errors.email}</ErrorMessage>}
                </InputWrapper>
                <InputWrapper>
                    <HiddenLabel id="tel">Téléphone</HiddenLabel>
                    <InputField type="tel" name="tel" placeholder="Téléphone *" value={inputForm.tel} onChange={handleChange} />
                    {errors.tel && <ErrorMessage>{errors.tel}</ErrorMessage>}
                </InputWrapper>
            </InputContainer>
            <LargerInputWrapper>
                <HiddenLabel id="subject">Sujet</HiddenLabel>
                <SelectField name="subject" value={inputForm.subject} onChange={handleChange} disabled={!!customSubject}>
                    <option value={customSubject ?? "Booking DJ"}>{customSubject ?? "Booking DJ"}</option>
            ...
            <LargerInputWrapper>
                ...
                <TextArea name="message" placeholder="Message *" value={inputForm.message} onChange={handleChange} />
