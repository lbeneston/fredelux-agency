            ...
            <DjCardWrapper>
                ...
                <DjCardHeader>
                    ...
                    <DjCardHeaderInformations>
                        <DjCardHeaderInformationsName>{djDetails.name}</DjCardHeaderInformationsName>
                        <DjCardHeaderInformationsMusicalGenres>
                ...
                <DjCardDescription>
                    <DjCardDescriptionTitles>
                        ...
                        <DjCardDescriptionTitlesText>Biographie</DjCardDescriptionTitlesText>
                    </DjCardDescriptionTitles>
                    <DjCardDescriptionParagraphe>{djDetails.biography}</DjCardDescriptionParagraphe>
